...
{
    public NotFoundException() : base(ApiResultStatusCode.NotFound)
    {
    ...
    public NotFoundException(object additionalData) : base(ApiResultStatusCode.NotFound, additionalData)
    {
    }
